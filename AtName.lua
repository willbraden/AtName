...
local bodyHint = frame:CreateFontString(nil, "OVERLAY", "GameFontNormalSmall")
bodyHint:SetPoint("TOPLEFT", scrollBorder, "BOTTOMLEFT", 0, -2)
bodyHint:SetTextColor(0.5, 0.5, 0.5)
bodyHint:SetText("e.g.  /cast [@{focus},exists] Lay on Hands; Lay on Hands")
